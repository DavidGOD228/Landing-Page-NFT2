export const morphIDText = {
  ...
  classiqueDesktop: 'This is the classic mode of the game where each player can start their experience immediately to learn the basic mechanics and then decide whether to switch to Eternal mode',
  eternalMobile: 'Metamorph è un avventura dinamica giocabile in terza persona di genere life simulator ambientato nel mondo virtuale Fata Morgana.',
  eternalDesktop: 'The Morph Eternal card allows for a full gaming experience where a player can earn in-game currency a Poligon-based cryptocurrency called Morganis',
}
