	...
	const members = [
		{
			...
			text: (
				<p className={classes.text}>
					Nazario 8+ years of experience in the gaming industry. Worked on Sims,
					SimCity. Early crypto adopter and investor.
				</p>
			),
			top: 7
		},
		{
			...
			text: (
				<p className={classes.text}>
					Johnas 15+ years of game development experience. Managed to work on
					...
					<div className={classes.secondBlock}>
						<div className={classes.membersMobile}>
							<h4 className={classes.membersAmount}>
								21 <span className={classes.membersText}>members</span>
							</h4>
							<p>
